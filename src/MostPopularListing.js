      ...
      <div id="belowNav">
        ...
        <div className="dark-img" style={{zIndex: "-1"}}>
            ...
            <div className="top-left2" style={{minWidth: "100%", marginTop: "11%"}}>
              <h1 style={{textAlign: "center", minWidth: "100%"}}>{t('popularTagTitle')}</h1>
            </div>
        </div>
        <h1 id="h1tagRequest" style={{color: "black", fontSize: "45px", padding: "2%", marginBottom: "0%"}}>{t('mostVisitedAunctions')}</h1>
        <p style={{paddingLeft: "2%", paddingRight: "2%", marginTop: "-1.5%"}}>{t('mostVisitedTagBelow')}</p>
        <AllListings/>
