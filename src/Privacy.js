      ...
      <div id="belowNav">
        ...
        <div className="dark-img" style={{zIndex: "-1"}}>
            ...
            <div className="top-left2" style={{minWidth: "100%", marginTop: "11%"}}>
              <h1 style={{textAlign: "center", minWidth: "100%"}}>{t('privacyTitle')}</h1>
            </div>
        </div>
        <h1 id="h1tagRequest" style={{color: "black", fontSize: "45px", padding: "2%", marginBottom: "2%"}}>{t('privacy')}</h1>
        <div id="rulesForum" style={{float: "left", minWidth: "96%", height: "100%", background: "white"}}>
          <p><b><span className="errorNotification">{t('ptagPrivacy')}</span></b> {t('pTagSearchSecond')} <NavLink id="logOrRegister" to="/User/Login">{t('ninethNav')}</NavLink>.</p>
        </div>
